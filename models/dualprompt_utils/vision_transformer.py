...
def vit_base_patch16_224_dualprompt(pretrained=False, **kwargs):
    ...
    model = create_vision_transformer('vit_base_patch16_224.augreg_in21k_ft_in1k', base_class=VisionTransformer, filter_fn=checkpoint_filter_fn, pretrained=pretrained, **model_kwargs)
    return model
